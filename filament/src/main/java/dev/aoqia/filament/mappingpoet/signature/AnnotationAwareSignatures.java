...
public final class AnnotationAwareSignatures {
    ...
    public static ClassSignature parseClassSignature(String signature,
        TypeAnnotationMapping annotationMapping,
    ...
    public static MethodSignature parseMethodSignature(String signature,
        TypeAnnotationMapping annotationMapping,
        ClassStaticContext context) {
        PoetClassMethodSignatureVisitor visitor = new PoetClassMethodSignatureVisitor(annotationMapping,
            context,
            false);
        new SignatureReader(signature).accept(visitor);
    ...
    public static TypeName parseFieldSignature(String signature,
        ...
        return parseSignature(signature,
            annotationMapping.getBank(TypeReference.newTypeReference(TypeReference.FIELD)),
            context);
    }

    public static TypeName parseSignature(String signature,
