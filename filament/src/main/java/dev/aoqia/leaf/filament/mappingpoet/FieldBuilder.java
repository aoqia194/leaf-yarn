...
public class FieldBuilder {
    ...
    private CodeBlock makeInitializer(String desc) {
        ...
        return CodeBlock.builder()
            .add(desc.equals("Ljava/lang/String;") ? "java.lang.String.valueOf(\"dummy\")" : "null")
            .build();
    }
    ...
    TypeName calculateType() {
        ...
        return parseAnnotatedType(fieldNode.desc,
            0,
            annotations.getBank(TypeReference.newTypeReference(TypeReference.FIELD)),
            context).getValue();
    }

    public static Map.Entry<Integer, TypeName> parseAnnotatedType(final String desc,
        final int start,
        TypeAnnotationBank annotations,
                ...
                do {
                    ...
                    if (ch == '$' || ch == ';') {
                        ...
                        if (currentClassName == null) {
                            String packageName =
                                nameStart < classNameSeparator ? desc.substring(nameStart, classNameSeparator)
                                    .replace('/', '.') : "";
    ...
    static void addFieldJavaDoc(TypeSpec.Builder enumBuilder,
    ...
    public static CodeBlock codeFromAnnoValue(Object value) {
        ...
        if (value instanceof List) {
            return ((List<?>) value).stream()
                .map(FieldBuilder::codeFromAnnoValue)
        ...
        throw new IllegalArgumentException(String.format("Don't know how to convert \"%s\" into annotation value",
            value));
    }
