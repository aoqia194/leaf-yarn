                ...
                switch (ch) {
                    ...
                    case 'L': {
                        ...
                        do {
                            ...
                            if (ch == '$' || ch == '<' || ch == ';') {
                                if (currentClass == null) {
                                    String packageName = nextSimpleNamePrev == -1 ? ""
                                        : signature.substring(nameStart, nextSimpleNamePrev).replace('/', '.');
                    ...
                    while (true) {
                        ...
                        if (ch == '.' || ch == ';' || ch == '<') {
                            ...
                            if (ch == '.' || ch == ';') {
                                ...
                                stack.push(Frame.ofGenericInnerClass((ParameterizedTypeName) stack.deque.getLast().typeNames.removeLast(),
                                    simpleName));
                                index++;
                                break quitLoop;
                            }
